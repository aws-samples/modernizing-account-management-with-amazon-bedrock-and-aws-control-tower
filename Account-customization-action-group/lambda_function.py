...
def lambda_handler(event, context):
    ...
    try:
        ...
        module_definitions = retrieve_module_definitions(kb_id, "arn:aws:bedrock:us-east-1::foundation-model/anthropic.claude-v2", user_request)

        # Construct the prompt with module definitions
        terraform_prompt = "Generate modular Terraform code for services: "
        ...
        readme_prompt = f"Generate a README for the Terraform configuration based on the user request: {user_request}"
